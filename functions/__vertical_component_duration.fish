function __vertical_component_duration
    set -l cmaroon "#eba0ac"
    set -l cmantle "#181825"
    __vertical_util_set vertical_duration_color $cmaroon \
        --background $cmantle
    __vertical_util_set vertical_duration_min 5000
    __vertical_util_set vertical_duration_prefix ""
    __vertical_util_set vertical_duration_prefix_color $cmantle \
        --background $cmantle
    __vertical_util_set vertical_duration_suffix ""
    __vertical_util_set vertical_duration_suffix_color $cmantle \
        --background $cmantle
