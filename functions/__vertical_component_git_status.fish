function __vertical_component_git_status
    __vertical_util_set vertical_git_status_color "#cba6f7" --bold \
        --background "#181825"
    __vertical_util_set vertical_git_status_prefix " "
    __vertical_util_set vertical_git_status_prefix_color "#cba6f7" --bold \
        --background "#181825"
    __vertical_util_set vertical_git_status_suffix ""
    __vertical_util_set vertical_git_status_suffix_color "#181825" --bold \
        --background "#181825"
