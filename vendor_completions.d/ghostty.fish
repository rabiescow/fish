set -l commands "+list-fonts +list-keybinds +list-themes +list-colors +list-actions +show-config +validate-config +show-face +crash-report"
...
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l gtk-gsk-renderer -r -f -a "default opengl"
...
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l gtk-adwaita  -f
...
complete -c ghostty -n "string match -q -- '+*' (commandline -pt)" -f -a "+list-fonts +list-keybinds +list-themes +list-colors +list-actions +show-config +validate-config +show-face +crash-report"
